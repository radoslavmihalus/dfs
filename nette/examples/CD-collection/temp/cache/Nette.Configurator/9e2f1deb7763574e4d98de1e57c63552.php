<?php
// source: /var/www/html/nette/examples/CD-collection/app/config.neon 
...
class SystemContainer extends Nette\DI\Container
{
	...
	protected $meta = array(
		'types' => array(
			'nette\\object' => array(
				...
				'22_App_Model_AlbumRepository',
				'23_App_Model_Authenticator',
				'container',
			),
			...
			'app\\model\\albumrepository' => array('22_App_Model_AlbumRepository'),
			'nette\\security\\iauthenticator' => array('23_App_Model_Authenticator'),
			'app\\model\\authenticator' => array('23_App_Model_Authenticator'),
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/var/www/html/nette/examples/CD-collection/app',
			'wwwDir' => '/var/www/html/nette/examples/CD-collection/www',
			'debugMode' => TRUE,
			...
			'tempDir' => '/var/www/html/nette/examples/CD-collection/app/../temp',
		));
	}


	/**
	 * @return App\Model\AlbumRepository
	 */
	public function createService__22_App_Model_AlbumRepository()
	{
		$service = new App\Model\AlbumRepository($this->getService('database.default.context'));
		return $service;
	}
	 ...
	 */
	public function createService__23_App_Model_Authenticator()
	{
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/var/www/html/nette/examples/CD-collection/app/../temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
	...
	{
		$service = new Nette\Database\Connection('sqlite:/var/www/html/nette/examples/CD-collection/app/model/demo.db3', NULL, NULL, NULL);
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/var/www/html/nette/examples/CD-collection/app/../temp');
		return $service;
	}
	...
	public function createServiceNette__latte()
	{
		...
		$service->setTempDirectory('/var/www/html/nette/examples/CD-collection/app/../temp/cache/latte');
	...
	{
		$service = new Nette\Application\PresenterFactory('/var/www/html/nette/examples/CD-collection/app', $this);
	...
	{
		$service = new Nette\Caching\Storages\PhpFileStorage('/var/www/html/nette/examples/CD-collection/app/../temp/cache', $this->getService('nette.cacheJournal'));
	...
	{
		$service = new Nette\Security\User($this->getService('nette.userStorage'), $this->getService('23_App_Model_Authenticator'));
