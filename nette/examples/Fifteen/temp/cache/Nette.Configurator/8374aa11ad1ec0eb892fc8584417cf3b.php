...
class SystemContainer extends Nette\DI\Container
{
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/var/www/html/nette/examples/Fifteen/app',
			'wwwDir' => '/var/www/html/nette/examples/Fifteen/www',
			'debugMode' => TRUE,
			...
			'tempDir' => '/var/www/html/nette/examples/Fifteen/app/../temp',
		));
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/var/www/html/nette/examples/Fifteen/app/../temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/var/www/html/nette/examples/Fifteen/app/../temp');
		return $service;
	}
	...
	public function createServiceNette__latte()
	{
		...
		$service->setTempDirectory('/var/www/html/nette/examples/Fifteen/app/../temp/cache/latte');
	...
	{
		$service = new Nette\Application\PresenterFactory('/var/www/html/nette/examples/Fifteen/app', $this);
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\PhpFileStorage('/var/www/html/nette/examples/Fifteen/app/../temp/cache', $this->getService('nette.cacheJournal'));
