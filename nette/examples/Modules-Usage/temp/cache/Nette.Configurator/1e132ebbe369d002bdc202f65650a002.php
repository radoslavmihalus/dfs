<?php
// source: /var/www/html/nette/examples/Modules-Usage/app/config.neon 
...
class SystemContainer extends Nette\DI\Container
{
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/var/www/html/nette/examples/Modules-Usage/app',
			'wwwDir' => '/var/www/html/nette/examples/Modules-Usage/www',
			'debugMode' => TRUE,
			...
			'tempDir' => '/var/www/html/nette/examples/Modules-Usage/app/../temp',
		));
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/var/www/html/nette/examples/Modules-Usage/app/../temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/var/www/html/nette/examples/Modules-Usage/app/../temp');
		return $service;
	}
	...
	public function createServiceNette__latte()
	{
		...
		$service->setTempDirectory('/var/www/html/nette/examples/Modules-Usage/app/../temp/cache/latte');
	...
	{
		$service = new Nette\Application\PresenterFactory('/var/www/html/nette/examples/Modules-Usage/app', $this);
	...
	{
		$service = new Nette\Caching\Storages\PhpFileStorage('/var/www/html/nette/examples/Modules-Usage/app/../temp/cache', $this->getService('nette.cacheJournal'));
