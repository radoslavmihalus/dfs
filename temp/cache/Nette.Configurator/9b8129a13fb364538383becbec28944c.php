<?php
// source: /var/www/html/dfs/app/config.neon 
...
class SystemContainer extends Nette\DI\Container
{
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/var/www/html/dfs/app',
			'wwwDir' => '/var/www/html/dfs',
			'debugMode' => TRUE,
			...
			'tempDir' => '/var/www/html/dfs/app/../temp',
		));
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/var/www/html/dfs/app/../temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/var/www/html/dfs/app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Application\PresenterFactory('/var/www/html/dfs/app', $this);
	...
	{
		$service = new Nette\Caching\Storages\PhpFileStorage('/var/www/html/dfs/app/../temp/cache', $this->getService('nette.cacheJournal'));
