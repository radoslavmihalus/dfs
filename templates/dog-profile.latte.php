        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <ul class="dog-information-list">
                    ...
                    <li class="text-uppercase"><i class="fa fa-file-text-o" style="margin-right: 10px;color:#777;"></i>spkp 1304</li>
            ...
            <div class="container-fluid profile-menu">
                <div class="collapse navbar-collapse" id="profile-menu" role="navigation" style="padding: 0px;">
                    <ul class="nav navbar-nav" style="margin:0px;">
                        ...
                        <li><a href="#" class="page-scroll text-uppercase landing_navbar_typography">{_ 'Working exams'}</a></li>
                        <li><a href="#" class="page-scroll text-uppercase landing_navbar_typography">{_ 'Health'}</a></li>
                        <li><a href="#" class="page-scroll text-uppercase landing_navbar_typography">{_ 'Pedigree'}</a></li>
                        ...
                        <li><a href="#" class="page-scroll text-uppercase landing_navbar_typography">{_ 'Matings'}</a></li>
                        <li><a href="#" class="page-scroll text-uppercase landing_navbar_typography">{_ 'Coowners'}</a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<div class="col-md-12">
        {include 'dog-mating-list.latte.php'}
</div>