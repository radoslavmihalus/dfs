    ...
    <div class="panel-body component">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <span class="profile-type-description"><i class="fa fa-home"></i>&nbsp;&nbsp;Kennel</span>
            ...
            <div class="container-fluid profile-menu">
                <div class="collapse navbar-collapse" id="profile-menu" role="navigation" style="padding: 0px;">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="#" class="page-scroll text-uppercase landing_navbar_typography">Our dogs</a></li>
                        <li><a href="#" class="page-scroll text-uppercase landing_navbar_typography">Planned litters</a></li>
                        <li><a href="#" class="page-scroll text-uppercase landing_navbar_typography">Puppies for sale</a></li>
                        ...
                        <li><a href="#" class="page-scroll text-uppercase landing_navbar_typography">Followers</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="col-lg-12">
        <div class="col-md-4">
            ...
            <div class="panel-body component col-lg-12">
                <!-- FCI number panel-->
                <div class="panel-description">FCI number 
                </div>
                ...
                <hr>
                <!-- Kennel breed panel-->
                <div class="panel-description">Breeds bred by our kennel</div>
                <div class="text-justify" style="font-size:12px;padding-top: 10px;">
                    Cane Corso Italiano
                </div>
                <hr>
                <!-- Kennel description panel-->
                <div class="panel-description">About us 
                </div>
                <div class="text-justify" style="font-size:12px;padding-top: 10px;">
                ...
                <hr>
                <!-- Kennel website-->
                <div class="panel-description">Website 
                </div>
                <div class="text-justify" style="font-size:12px;padding-top: 10px;">
                    www.something.com
                </div>
