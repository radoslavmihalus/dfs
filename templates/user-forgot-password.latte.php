...
<html lang="en">
    ...
    <body role="document">
        ...
        <section id="join">
            <div class="jumbotron landing_header_forgot_password">
                <div class="container animatedParent animateOnce">
                    <div class="row animated fadeIn">
                        <div class="col-md-8 container" style="float:none;">
                            <p class="text-center text-uppercase landing_header_slogan"><strong>{_ 'Forgot your password'}?</strong></p>
                            <div class="form-group">
                                <span style="display:block;margin-bottom: 5px; color:white;">{_ 'Your email'}</span>
                                <input type="email" class="form-control" id="txtEmail" placeholder="{_ 'Email'}">
                            </div>
                            <button type="submit" id="btnForgotPasswprd" class="btn btn-danger btn-block"><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span>&nbsp;&nbsp;{_ 'Send'}</button>
                        </div>
                    </div>
                </div>
            </div>
