<?php
// source: templates/handler-profile.latte.php

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('7366217952', 'html')
;
//
// main template
//
    ...
    <div class="panel-body component">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <span class="profile-type-description"><i class="glyphicons glyphicons-shirt"></i>&nbsp;&nbsp;<?php echo Latte\Runtime\Filters::escapeHtml($template->translate('Handler'), ENT_NOQUOTES) ?></span>
            ...
            <div class="container-fluid profile-menu">
                <div class="collapse navbar-collapse" id="profile-menu" role="navigation" style="padding: 0px;">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="#" class="page-scroll text-uppercase landing_navbar_typography"><?php echo Latte\Runtime\Filters::escapeHtml($template->translate('Breeds for Handling'), ENT_NOQUOTES) ?></a></li>
                        ...
                        <li><a href="#" class="page-scroll text-uppercase landing_navbar_typography"><?php echo Latte\Runtime\Filters::escapeHtml($template->translate('Certificates'), ENT_NOQUOTES) ?></a></li>
                        <li><a href="#" class="page-scroll text-uppercase landing_navbar_typography"><?php echo Latte\Runtime\Filters::escapeHtml($template->translate('Show results'), ENT_NOQUOTES) ?></a></li>
    ...
    <div class="col-lg-12">
        <div class="col-md-4">
            ...
            <div class="panel-body component col-lg-12">
                <div class="panel-description"><?php echo Latte\Runtime\Filters::escapeHtml($template->translate('About me'), ENT_NOQUOTES) ?>
