<?php
// source: templates/handler-registration.latte.php

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('4965832918', 'html')
;
//
// main template
//
    ...
    <div class="panel-body" style="background-color: white;margin-bottom: 10px;">
        <form id="frmCreateOwnerProfile">
            ...
            <div class="form-group">
                ...
                <input type="file" class="form-control font_size_13px" id="txtOwnerProfilePicture" placeholder="<?php echo Latte\Runtime\Filters::escapeHtml($template->translate('Your profile picture'), ENT_COMPAT) ?>">
            </div>
            <div class="form-group">
