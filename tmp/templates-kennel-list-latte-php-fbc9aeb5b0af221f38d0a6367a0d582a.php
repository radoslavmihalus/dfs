...
list($_b, $_g, $_l) = $template->initialize('5507716356', 'html')
;
//
// main template
//
...
<div class="panel-default col-lg-12 col-md-12 col-xs-12" style="font-size: 13px;min-width: 244px">
    ...
    <div class="row">
        <div class="col-lg-3 col-md-3 col-xs-12 padding">
            <a href="#">
                <div class="list-item">
                    <div class="list-item-image">
                        <img src="img/referer1.jpg"  class="pull-left image-list-thumb">
                        <span class="list-puppy-info" style="font-size:15px;"><i class="fa fa-info-circle"></i>&nbsp;We have puppies</span>
                    </div>    
