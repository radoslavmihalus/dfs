...
list($_b, $_g, $_l) = $template->initialize('6278529636', 'html')
;
//
// main template
//
...
<html lang="en">
    ...
    <body>
        <!-- top-menu -->
<?php $_b->templates['6278529636']->renderChildTemplate('top-menu.latte.php', $template->getParameters()) ?>
        <!-- /top-menu -->
        <!-- user-menu -->
<?php $_b->templates['6278529636']->renderChildTemplate('user-menu.latte.php', $template->getParameters()) ?>
        <!--/user-menu -->
...
<?php $_b->templates['6278529636']->renderChildTemplate('kennel-profile.latte.php', $template->getParameters()) ?>
                </div>
            </div>
        </div>
        <!-- /Main content -->
