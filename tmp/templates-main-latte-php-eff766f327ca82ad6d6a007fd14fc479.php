...
list($_b, $_g, $_l) = $template->initialize('4577548977', 'html')
;
//
// main template
//
...
<html lang="en">
    ...
    <body>
        <!-- top-menu -->
<?php $_b->templates['4577548977']->renderChildTemplate('top-menu.latte.php', $template->getParameters()) ?>
        <!-- /top-menu -->
        <!-- user-menu -->
<?php $_b->templates['4577548977']->renderChildTemplate('user-menu.latte.php', $template->getParameters()) ?>
        <!--/user-menu -->
...
<?php $_b->templates['4577548977']->renderChildTemplate('dog-list.latte.php', $template->getParameters()) ?>
                </div>
            </div>
        </div>
        <!-- /Main content -->
