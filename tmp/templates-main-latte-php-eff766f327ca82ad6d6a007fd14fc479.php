...
list($_b, $_g, $_l) = $template->initialize('3164067322', 'html')
;
//
// main template
//
...
<html lang="en">
    ...
    <body>
        <!-- top-menu -->
<?php $_b->templates['3164067322']->renderChildTemplate('top-menu.latte.php', $template->getParameters()) ?>
        <!-- /top-menu -->
        <!-- user-menu -->
<?php $_b->templates['3164067322']->renderChildTemplate('user-menu.latte.php', $template->getParameters()) ?>
        <!--/user-menu -->
...
<?php $_b->templates['3164067322']->renderChildTemplate('edit-account.latte.php', $template->getParameters()) ?>
                </div>
            </div>
        </div>
        <!-- /Main content -->
