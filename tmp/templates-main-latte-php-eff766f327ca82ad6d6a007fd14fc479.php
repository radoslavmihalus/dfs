...
list($_b, $_g, $_l) = $template->initialize('1513819116', 'html')
;
//
// main template
//
...
<html lang="en">
    ...
    <body>
        <!-- top-menu -->
<?php $_b->templates['1513819116']->renderChildTemplate('top-menu.latte.php', $template->getParameters()) ?>
        <!-- /top-menu -->
        <!-- user-menu -->
<?php $_b->templates['1513819116']->renderChildTemplate('user-menu.latte.php', $template->getParameters()) ?>
        <!--/user-menu -->
...
<?php $_b->templates['1513819116']->renderChildTemplate('list-of-kennels.latte.php', $template->getParameters()) ?>
                </div>
            </div>
        </div>
        <!-- /Main content -->
