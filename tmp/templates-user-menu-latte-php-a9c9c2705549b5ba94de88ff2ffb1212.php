...
list($_b, $_g, $_l) = $template->initialize('9674166243', 'html')
;
//
// main template
//
...
<!--                    <p class="user-block-type"><i class="fa fa-user"></i>&nbsp;&nbsp;</i>Owner of purebred dog</p>
            ...
            <li >
                <a href="#" class="create-profile-link">
                    <i class="fa fa-user-plus"></i>&nbsp;&nbsp;<?php echo Latte\Runtime\Filters::escapeHtml($template->translate('Create profile'), ENT_NOQUOTES) ?>
