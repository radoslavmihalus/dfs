<?php /** Configuration file; blueticket® blueticketFORMS v.1.0; 06/2014 */
class blueticket_forms_config
{
    // default connection
    public static $dbname = 'u147232041_dfs'; // Your database name
    public static $dbuser = 'u147232041_dfs'; // Your database username
    public static $dbpass = 'dfs123'; // // Your database password
    public static $dbhost = 'localhost';//'31.170.165.185'; // Your database host, 'localhost' is default.
    ...
    // scripts
    public static $load_bootstrap = true; // turn on, if you want to load bootstrap via blueticketFORMS
    public static $load_googlemap = true; // loads google map api for 'POINT' type. Turn off, if your site already uses it.
    public static $load_jquery = true; // loads jQuery, turn it off if you already have jQuery on your page. jQuery version must be at least 1.7. If your jQuery loads in the bottom of page, you must activate $manual_load and use  blueticket_forms::load_css() & blueticket_forms::load_js() on your page.
    ...
    // anti XSS
    public static $auto_xss_filtering = true; // enable all blueticket_forms's POST and GET data filtering
